    ...
    for m = k:length(uniqsector)
        ...
        if k == m
            ...
            for l = 1:itern
                ...
                data2(:,index1)=[];
                tic;
                [mu_hat, tstat,pvalue,ksei2] = CI_ustat_comp(percent,data1,data2,  type,r);
...
save("./data/stock_market/result/CI_stockall5_comp","recordpval","recordpvalstd","recordtstat","recordtstatstd","timecost","ksei2_all","mu_hat_all")
