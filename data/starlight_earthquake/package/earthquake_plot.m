...
%                 pbaspect([5 1 1])
        ...
        saveas(h(t),strcat("./data/starlight_earthquake/plot/earthquake_type",string(typeall(i)),"_",string(length_date),".png"))
    end
end
...
%                 pbaspect([5 1 1])
        ...
        % xticklabels(ax,{})
        tlo.TileSpacing = 'compact';
        saveas(h(t),strcat("./data/starlight_earthquake/plot/earthquake_type",string(typeall(i)),"_",string(length_date),"nonlegend.png"))
    end
end
