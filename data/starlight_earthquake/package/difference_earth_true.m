...
mu_true(1,1) = complete_u(sample_n,sample_m, data_ave1, data_ave0,type);
timecost(1,1) = toc;

save(strcat("./data/starlight_earthquake/result/result_earthquake_true",string(length_date)),"mu_true","timecost")
