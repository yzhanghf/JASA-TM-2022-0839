...
%     legend("Original","Reduced",'Location','southoutside','FontSize', 18,'Orientation','horizontal')
    ...
    saveas(h(t),strcat("./data/starlight_earthquake/plot/starlight_type",string(i),".png"))
end
...
%     legend("Original","Reduced",'Location','southoutside','FontSize', 18,'Orientation','horizontal')
    ...
    % xticklabels(ax,{})
    tlo.TileSpacing = 'compact';
    saveas(h(t),strcat("./data/starlight_earthquake/plot/starlight_type",string(i),"nolegend.png"))
end
