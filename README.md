...
5. Run data example codes on Unity.
   ...
   The information from Table 5 were manually collected from: data/starlight_earthquake/result and data/stock_market, open each file and look for variable "timecost".
